...
class GlobalMethods {
    ...
    static readASN1(file) {
        try {
            const asn1Object = node_forge_1.asn1.fromDer(file);
            return asn1Object;
        }
        catch (err) {
            throw new ERROR_GENERAL_ERROR_1.default('No se pudo decodificar el archivo ASN1. Verifique que el archivo tenga un formato DER válido.', err);
        }
    }
