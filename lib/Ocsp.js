...
})(OCSP_REQUEST_STATUS = exports.OCSP_REQUEST_STATUS || (exports.OCSP_REQUEST_STATUS = {}));
...
})(OCSP_CERTIFICATE_STATUS = exports.OCSP_CERTIFICATE_STATUS || (exports.OCSP_CERTIFICATE_STATUS = {}));
class Ocsp {
    ...
    getOCSPRequest() {
        ...
        const hashPublicKeyFromANS1 = GlobalMethods_1.GlobalMethods.hash(publicKeyFromANS1, 'sha1');
        ...
        const ans1OCSPRequest = node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
            node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                    node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                        node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                            node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.OID, false, node_forge_1.asn1.oidToDer(node_forge_1.pki.oids['sha1']).getBytes()), node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.NULL, false, '')]),
                ...
                node_forge_1.asn1.create(node_forge_1.asn1.Class.CONTEXT_SPECIFIC, node_forge_1.asn1.Type.INTEGER, true, [
                    node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                        node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [
                            ...
                            node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.OCTETSTRING, false, Buffer.from('041064bb982b0f6236984ec9d8c4997b6996', 'hex'))
                        ])
                    ])
                ])
            ])
        ]);
        const ocspRequestDer = node_forge_1.asn1.toDer(ans1OCSPRequest);
    ...
    getIssuerNameBinary() {
        ...
        const createBlock = (oid, value, type) => {
            ...
            return node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SET, true, [node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.SEQUENCE, true, [node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, node_forge_1.asn1.Type.OID, false, node_forge_1.asn1.oidToDer(oid).getBytes()), node_forge_1.asn1.create(node_forge_1.asn1.Class.UNIVERSAL, type, false, value)])]);
        };
        attrs.forEach((attr) => {
