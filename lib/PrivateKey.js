...
class PrivateKey {
    constructor(x509Binary) {
        ...
        let errors = [];
        const isEncrypted = node_forge_1.asn1['validate'](this.ans1Object, this.encryptedPrivateKeyValidator, null, errors);
        if (!isEncrypted) {
    ...
    rsaDecrypt(encryptedText, passwordKey) {
        const privateKeyInfo = node_forge_1.pki.decryptPrivateKeyInfo(this.ans1Object, passwordKey);
